import{F as gm,L as pm,t as ae,u as It,v as oa,w as $l,x as gs,y as _m,m as ym,e as Ql,z as Im,j as Tm,A as Em,B as wm,C as ui,E as Wl,G as Hl,g as Am,i as vm,H as Rm,r as Ic,S as Pm}from"./index.esm-BlcWmb1Q.js";var Tc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(){this._=void 0}}function qg(r,t,e){return r instanceof Yn?(function(s,i){const a={fields:{[Vh]:{stringValue:Ph},[bh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ci(i)&&(i=Di(i)),i&&(a.fields[Sh]=i),{mapValue:a}})(e,t):r instanceof fn?Xh(r,t):r instanceof mn?Zh(r,t):r instanceof gn?(function(s,i){const a=Yh(s,i),u=gi(a)+gi(s.Ae);return us(a)&&us(s.Ae)?Ea(u):Ni(s.serializer,u)})(r,t):r instanceof Xn?(function(s,i){return jc(s,i,Math.min)})(r,t):r instanceof Zn?(function(s,i){return jc(s,i,Math.max)})(r,t):void 0}function Bg(r,t,e){return r instanceof fn?Xh(r,t):r instanceof mn?Zh(r,t):e}function Yh(r,t){return r instanceof gn?Dh(t)?t:{integerValue:0}:null}class Yn extends Fi{}class fn extends Fi{constructor(t){super(),this.elements=t}}function Xh(r,t){const e=td(t);for(const n of r.elements)e.some((s=>ie(s,n)))||e.push(n);return{arrayValue:{values:e}}}class mn extends Fi{constructor(t){super(),this.elements=t}}function Zh(r,t){let e=td(t);for(const n of r.elements)e=e.filter((s=>!ie(s,n)));return{arrayValue:{values:e}}}class wa extends Fi{constructor(t,e){super(),this.serializer=t,this.Ae=e}}class gn extends wa{}class Xn extends wa{}class Zn extends wa{}function jc(r,t,e){if(!Dh(t))return r.Ae;const n=e(gi(t),gi(r.Ae));return us(t)&&us(r.Ae)?Ea(n):Ni(r.serializer,n)}function gi(r){return ut(r.integerValue||r.doubleValue)}function td(r){return cs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
